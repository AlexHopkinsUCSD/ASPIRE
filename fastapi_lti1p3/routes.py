...
templates = Jinja2Templates(directory="fastapi_lti1p3/auth_frames/templates")
...
async def oidc_auth_response(
    ...
    try: 
        session_id, csrf_token, target_link_uri, storage_target, oidc_auth_domain = await lti_adapter.validateResponse()
